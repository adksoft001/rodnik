...
use app\blocks\VideoWidget\VideoWidget;
...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        <noscript>
            <div><img src="https://mc.yandex.ru/watch/89214513" style="position:absolute; left:-9999px;" alt=""/></div>
        </noscript>
        <!-- /Yandex.Metrika counter-->
                ...
                <div class="header-page__inner">
                    ...
                    <div class="header-page__contacts">
                        <div class="contacts-item">
                            <div class="contacts-item__adress"><a href="https://yandex.ru/maps/-/CCURZNGv3D"
                                                                  target="_blank">Евпатория, Межквартальный проезд
                                    11А</a></div>
                            <div class="contacts-item__phone">

                                <?php if (isset($serviceGroup['url']) && ($serviceGroup['url'] === 'detejling' || $serviceGroup['parent_id'] === 306)): ?>
                                    <a class="phone__data1 " style="text-align: center" href="tel:+79785408282"><b>8
                                            (978) 540-82-82 - Основной телефон</b></a>
                                <?php elseif (isset($serviceGroup['url']) && (in_array($serviceGroup['parent_id'], [4, 474, 500]) || in_array($serviceGroup['url'], ['pokraska-kuzova', 'kuzovnoj-remont', 'remont-avtostekol']))): ?>
                                    <a class="phone__data1" style="text-align: center" href="tel:+79787321600"><b>8
                                            (978) 732-16-00 - Основной телефон</b></a>
                                <?php else: ?>
                                    <a class="phone__data1" href="tel:+79780776282"><b>8 (978) 077-62-82 - Основной
                                            телефон </b></a>
                                <?php endif; ?>
                                <a class="phone__data1" style="text-align: center" href="tel:+79783041952">8 (978)
                                    304-19-52 - Дополнительный</a>
                            </div>
                        </div>
                    </div>
                    <div class="header-phones">
                        ...
                        <b>
                            <div class="header-center-schedule"><b>Время работы: с 08:30 до 18:00</div>
                            <div class="header-center-schedule">Сб c 9:00 до 14:00. Вс выходной</div>
                        </b>
                        <?php //<a href="tel:74994441437" class="header-phones-phone"><span>8 (499) 444-14-37</span></a> ?>
                        <a href="#" class="mbtn mbtng modal-form-open" data-name="Заказать звонок"
                           data-type="consultation" tabindex="0">Получить консультацию</a>
                ...
                <nav class="navbar">
                    <div class="navbar__mobile">
                        <div class="navbar__mobile-right">
                            <a href="https://yandex.ru/navi?rtext=45.255378%2C33.379174~45.221974%2C33.353902&rtt=auto"
                               target="_blank"
                               style="font-size: 14px; font-weight: 800; color: black; text-decoration: none">Межквартальный
                                проезд 11А</a>
                            <div class="contacts-item__phone">
                                <a class="phone__data" id="sev" href="tel:+79780776282">8 (978) 077-62-82</a>
                                <a class="phone__data1" href="tel:+79783041952">8 (978) 304-19-52</a>
                            </div>
                            <div>
                                <button class="navbar-toggle collapsed" type="button" data-toggle="collapse"
                                        data-target="#bs-navbar" aria-expanded="false"><span class="sr-only">Toggle navigation</span><span
                    ...
                    <div class="collapse navbar-collapse" id="bs-navbar" style="position:relative;">
                        <ul class="nav navbar-nav">
                            ...
                            <li data-toggle="collapse" data-target="#bs-navbar"><a href="/#header_advantage">Акции</a>
                            </li>
                            <li data-toggle="collapse" data-target="#bs-navbar"><a href="/#header_raiting">Отзывы</a>
                            </li>
                            <li data-toggle="collapse" data-target="#bs-navbar"><a href="/contact/">Контакты</a></li>
                            <div class="dropdown">
                                <li class="btn btn-outline-success dropdown-toggle" type="button" id="dropdownMenu2"
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenu2"
                                    ...
                                    <a class="dropdown-item" type="button" href="/comma/antifriz/">Антифризы экстра
                                        класса</a>
                                    <a class="dropdown-item" type="button" href="/comma/tormoz/">Тормозные и
                                        гидравлические жидкости</a>
                                    <a class="dropdown-item" type="button" href="/comma/transmissiya/">Трансмиссионные
                                        масла</a>
                                </div>
                            </div>
    ...
    <footer>
        ...
        <?= VideoWidget::block([
            'url' => isset($serviceGroup['url']) ? $serviceGroup['url'] : null,
            'serviceId' => isset($serviceGroup['parent_id']) ? $serviceGroup['parent_id'] : null,
        ]); ?>
    </footer>

    <script type="text/javascript">var __cs = __cs || [];
        __cs.push(["setCsAccount", "1ovq5_22PNk11r3mdTITRF8GN1i6ssNt"]);</script>
    <?php $this->endBody(); ?>
    <script>
