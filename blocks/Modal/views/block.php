...
<div class="modal modal-form" id="modal-form">
    <form id="recall-form">
        ...
        <?= Html::hiddenInput('page', \Yii::$app->getRequest()->getUrl()) ?>
...
<div class="modal modal-zaloba" id="modal-zaloba">
    <form id="recall-form">
        ...
        <?= Html::hiddenInput(\Yii::$app->getRequest()->csrfParam, \Yii::$app->getRequest()->getCsrfToken(), []); ?>
        <h4 class="text-center" id="recall-form-name"></h4>
        <p class="middle_text_form">Здесь вы можете оставить жалобы – руководство компании "СТО Родник" обязательно рассмотрят ваше обращение. Ваше мнение важно для нас.</p>
        <div class="form-group">
        ...
        <label>
            ...
            <strong>СРОЧНО</strong> прошу связаться со мной руководство "СТО Родник"
        </label>
        <div class="form-group">
