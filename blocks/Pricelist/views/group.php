...
<!--    <h3 class="title_block b5bgc--><?php //= $iter; ?><!--">--><?php //=str_replace(' (ТО) авто', '', $group->name);  ?><!--</h3>-->
<!--    <div class="info">-->
<!--        --><?php //= $items; ?>
<!--    </div>-->
<!--</div>-->
<div class="price_category">
    <div id="price-<?= str_replace([' ', '(', ')'], '_', $group->name); ?>" class="calc__price_category">
        <div class="cals__price_category_left">
            <img class="img-svg" src="/img/serviceIcon/<?= str_replace([' ', '(', ')'], '_', $group->name); ?>.svg" alt="">
