                    ...
                    <div class="about_company__block">
                        ...
                        <div class="about_company__block__right">
                            <div class="about_company__block__right__item">
                                ...
                                <div class="about_company__block__right__item__text">
                                    <p>ВСЕ В ОДНОМ МЕСТЕ</p>
                                    <small>Крупнейший автосервис в Евпатории - ТО, слесарный и кузовной ремонт,
                                        детейлинг,
                                        техосмотр.</small>
                                </div>
                            </div>
                            <div class="about_company__block__right__item">
                                ...
                                <div class="about_company__block__right__item__text">
                                    ...
                                    <small>Для Вашего автомобиля <?php
                                        if ($brand && !$model) {
                                            echo trim($brand->rus_name, "(,)");
                                        } elseif ($model) {
                                            echo trim($model->rus_name, "(,)");
                                        }
                                        ?> у нас всегда присутствуют запчасти в наличии и под заказ.</small>
                                </div>
                            </div>
                            <div class="about_company__block__right__item">
                                <img src="/img/rodnik/about_company/icon/3.svg" alt="">
                                <div class="about_company__block__right__item__text">
                                    ...
                                    <small>Смета оговаривается после
                                        диагностики <?php
                                        if ($brand && !$model) {
                                            echo $brand->name;
                                        } elseif ($model) {
                                            echo $brand->name.' '. $model->name;
                                        }
                                        ?>, цена не меняется в ходе работы.</small>
                                </div>
                            </div>
                            <div class="about_company__block__right__item">
                                <img src="/img/rodnik/about_company/icon/4.svg" alt="">
